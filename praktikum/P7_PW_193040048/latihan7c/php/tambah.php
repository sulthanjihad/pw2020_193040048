    ...
    <div class="container mx-auto">
      ...
      <form method="post" enctype="multipart/form-data">
        <div class="form-group ">
          ...
          <img src="../assets/img/nophoto.jpg" alt="" width="250" class="img-preview mt-5">
          <small id="Cover" class="form-text text-warning">ukuran Cover buku 400x200.</small>
        </div>
        ...
        <div class="form-group m-5 mx-auto">
          ...
          <small id="Cover" class="form-text text-warning">Diawali RP | Contoh "RP90.000.</small>
        </div>
